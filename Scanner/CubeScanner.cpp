...
vector<vector<RubiksCube::COLOR>>
rotateFaceClockwise(const vector<vector<RubiksCube::COLOR>> &face)
{
    vector<vector<RubiksCube::COLOR>> res(3, vector<RubiksCube::COLOR>(3));
...
void CubeScanner::scan(RubiksCube &cube)
{
    ...
    for (int face = 0; face < 6; face++)
    {
        while (true)
        {
            ...
            // RAW debug print BEFORE any rotation
            // cout << "\n=== Face " << face << " RAW ===\n";
            // for (int i = 0; i < 3; i++)
            // {
            //     for (int j = 0; j < 3; j++)
            //         cout << RubiksCube::getColorLetter(
            //                     static_cast<RubiksCube::COLOR>(grid[i][j]))
            //              << " ";
            //     cout << "\n";
            // }
            // switch (face) {
            //     case 0: // U: 90° CCW
            //         grid = rotateFaceClockwise(rotateFaceClockwise(rotateFaceClockwise(grid)));
            //         break;
            //     case 1: // L: 90° CW
            ...
            //         break;
            //     case 5: // D: 180°
            //         grid = rotateFaceClockwise(rotateFaceClockwise(grid));
            //         break;
            // }
            cubeGrid[face] = grid;

...
int RubiksCubeBitboard::get5bitCorner(std::string corner) {
    int ret = 0;
...
RubiksCube &RubiksCubeBitboard::uPrime() { this->u(); this->u(); this->u(); return *this; }
RubiksCube &RubiksCubeBitboard::u2() { this->u(); this->u(); return *this; }
...
RubiksCube &RubiksCubeBitboard::lPrime() { this->l(); this->l(); this->l(); return *this; }
RubiksCube &RubiksCubeBitboard::l2() { this->l(); this->l(); return *this; }
...
RubiksCube &RubiksCubeBitboard::fPrime() { this->f(); this->f(); this->f(); return *this; }
RubiksCube &RubiksCubeBitboard::f2() { this->f(); this->f(); return *this; }
...
RubiksCube &RubiksCubeBitboard::rPrime() { this->r(); this->r(); this->r(); return *this; }
RubiksCube &RubiksCubeBitboard::r2() { this->r(); this->r(); return *this; }
...
RubiksCube &RubiksCubeBitboard::bPrime() { this->b(); this->b(); this->b(); return *this; }
RubiksCube &RubiksCubeBitboard::b2() { this->b(); this->b(); return *this; }
...
RubiksCube &RubiksCubeBitboard::dPrime() { this->d(); this->d(); this->d(); return *this; }
RubiksCube &RubiksCubeBitboard::d2() { this->d(); this->d(); return *this; }
